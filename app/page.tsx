    ...
    <div className="home-container">
      ...
      <section className="hero">
        <div className="hero-content container">
          ...
          <h1 className="hero-title">Deja de buscar tendencias y empieza a dictarlas.</h1>
          <p className="hero-description">
            Descubre nuestra exclusiva selección de prendas diseñadas para destacar tu ESTILO personal.
          </p>
